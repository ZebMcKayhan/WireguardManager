...
Note2: Despite my best effort I cant seem to get ipv6 packages from wg21 to be forwarded to wan port. The package reaches the firewall POSTROUTING Chain but it never reaches the FORWARD chain so during routing the package disapears (altough "ip -6 route get 2600:: from fc00:192:196:100::2 iif wg21" provided a perfectly good route). If anyone reading this figures out why, please post in snbforum (link on top of page) or pm me here on github.
